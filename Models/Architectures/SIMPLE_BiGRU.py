...
class SIMPLE_BiGRU:
    ...
    def create_bigru(self):
        ...
        x = Bidirectional(GRU(units=self.rec_units, activation="relu", return_sequences=True))(x)
        x = Bidirectional(GRU(units=self.rec_units, activation="relu", return_sequences=False))(x)
